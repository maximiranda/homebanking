...
public class HomebankingApplication {
	...
	public CommandLineRunner initData(ClientRepository clientRepository, AccountRepository accountRepository, TransactionRepository transactionRepository, LoanRepository loanRepository, ClientLoanRepository clientLoanRepository, CardRepository cardRepository){
		return (args) -> {
			...
			Account account2 = new Account("VIN-00000002", LocalDateTime.now().plusDays(1), 7500.0, client1);
			Account account3 = new Account("VIN-00000003", LocalDateTime.now(),156000.0, client2);
			...
			Card card4 = new Card("3333 6666 8888 1234", CardType.CREDIT, CardColor.SILVER, 456, LocalDateTime.now(), LocalDateTime.now().plusYears(5), client1);
